...
class PersonalRepository:
    ...
    async def create_personal(self, personal: Personal) -> Personal:
    ...
    async def get_personal(self, personal_id: int) -> Optional[Personal]:
    ...
    async def get_all_personal(self) -> List[Personal]:
    ...
    async def update_personal(self, personal_id: int, personal: Personal) -> Optional[Personal]:
